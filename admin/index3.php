 ...
 while ($data = mysqli_fetch_array($query)) 
  {
   ?>
        <tr align="center">
         ...
         <td>
            <a  class="hapus" href="hapus.php?id=<?php echo $data['id']; ?>"><input type="button" value="hapus"></a> 
              <a  class="edit" href="edit.php?id=<?php echo $data['id']; ?>"><input type="button" value="edit"></a>             
            </td>
            <?php $no++;
          } 
          ?>
